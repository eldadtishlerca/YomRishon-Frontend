const gBoards = [
  {
    ...
    statuses: [
      { name: '', color: '#0C4C4C4' },
      { name: 'Not Assignee', color: '#7F5347' },
      { name: 'Working On It', color: '#FDAB3D' },
      { name: 'Bug', color: '#E2445C' },
      { name: 'Wating For Dev', color: '#784BD1' },
      { name: 'Wating For Deploy', color: '#037F4C' },
      { name: 'Wating For QA', color: '#FF158A' },
        ...
        tasks: [
          {
            ...
            status: { name: 'Working On It', color: '#FDAB3D' },
            priority: { name: 'Done', color: '#00C875' },
          ...
          },
          {
            ...
            status: { name: 'Wating For Dev', color: '#784BD1' },
            priority: { name: 'Medium', color: '#D974B0' },
          ...
          },
          {
            ...
            status: { name: 'Waiting for Dev', color: '#784BD1' },
            priority: { name: 'Low', color: '#2B76E5' },
        ...
        tasks: [
          {
            ...
            status: { name: 'Working On It', color: '#FDAB3D' },
            priority: { name: 'High', color: '#BB3354' },
          ...
          },
          {
            ...
            status: { name: 'Wating For QA', color: '#FF158A' },
            priority: { name: 'High', color: '#BB3354' },
      ...
      },
      {
        ...
        tasks: [
          ...
          },
          {
            ...
            membersIds: [],
            status: { name: 'Not Assignee', color: '#7F5347' },
            priority: { name: 'Low', color: '#2B76E5' },
